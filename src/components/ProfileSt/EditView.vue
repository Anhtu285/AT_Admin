<template>
  <div class="dialog">
    <div class="dialog-header">Chỉnh sửa thông tin sinh viên</div>
    <div class="dialog-body">
      ...
      <div class="form-group">
        <label for="phoneSv">Số điện thoại</label>
        <input id="phoneSv" type="text" v-model="data.phoneSv" class="input" />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="note">Số CCCD</label>
        <input id="note" type="text" v-model="data.cccd" class="input" />
      </div>
      <div class="form-group">
    ...
    async updateStudent() {
      try {
        ...
        const response = await axios.put(
          `https://localhost:44356/api/ProfileSt/${this.data.studentId}`,
          this.data
        )
        this.$emit('close')
